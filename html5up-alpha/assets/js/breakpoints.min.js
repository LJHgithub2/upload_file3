...
var breakpoints=function(){
    ...
    var t={
        ...
        init:function(e){
            t.list=e,window.addEventListener("resize",t.poll),
            ...
            active:function(e){
                var n,a,s,i,r,d,c;if(!(e in t.media)){
                    ...
                    n=e.substr(1)):(a="eq",n=e),
                    n&&n in t.list)if(i=t.list[n],
                        Array.isArray(i)){
                            if(r=parseInt(i[0]),
                            d=parseInt(i[1]),
                            isNaN(r)){
                            ...
                            if(isNaN(r))switch(a){
                                case"gte":s="screen";
                                break;case"lte":s="screen and (max-width: "+d+c+")";
                                break;case"gt":s="screen and (min-width: "+(d+1)+c+")";
                                break;case"lt":s="screen and (max-width: -1px)";
                                break;case"not":s="screen and (min-width: "+(d+1)+c+")";
                                break;default:s="screen and (max-width: "+d+c+")"
